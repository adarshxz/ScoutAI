    ...
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", position: "relative", overflow: "hidden", padding: "0 16px" }}>
      ...
      <motion.div initial={{ opacity: 0, y: 30, scale: 0.97 }} animate={{ opacity: 1, y: 0, scale: 1 }} transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1] }}
        ...
        <div className="glass-card" style={{ padding: "32px 40px" }}>
          ...
          <button onClick={handleGoogleLogin} style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "center", gap: 12, padding: "12px", borderRadius: 12, border: "1px solid rgba(0, 0, 0,0.06)", background: "rgba(0, 0, 0,0.02)", color: "#000000", fontSize: "0.875rem", fontWeight: 500, cursor: "pointer", transition: "background 0.3s", marginBottom: 24, fontFamily: "inherit" }}
